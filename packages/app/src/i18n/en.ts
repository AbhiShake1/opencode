export const dict = {
  ...
  "sidebar.thread.controls": "Thread options",
  "sidebar.thread.organize": "Organize",
  "sidebar.thread.organize.byProject": "By project",
  "sidebar.thread.organize.chronological": "Chronological",
  "sidebar.thread.sort": "Sort",
  "sidebar.thread.sort.updated": "Updated (newest first)",
  "sidebar.thread.sort.created": "Created (newest first)",
  "sidebar.thread.filter": "Filter",
  "sidebar.thread.filter.all": "All threads",
  "sidebar.thread.filter.relevant": "Relevant threads",
  "sidebar.thread.archived.show": "Show archived threads",
  "sidebar.thread.archived.hide": "Show active threads",
  "sidebar.thread.archived.empty": "No archived threads",
  "sidebar.thread.section.today": "Today",
  "sidebar.thread.section.yesterday": "Yesterday",
  "sidebar.thread.section.older": "Older",
